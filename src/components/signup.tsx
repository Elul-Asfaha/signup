...
const Signup = () => {
    return (
        <div className='grid grid-cols-2 bg-[#112540] w-[80%] h-[80%] rounded-lg'>
            ...
            <div className='flex flex-col justify-center px-10'>
                <div className='flex flex-col gap-2 items-center px-8 bg-[#0B1B32] rounded-lg h-[90%] py-10'>
                    <p className='text-gray-200'>
                        ...
                        agency ownerm Reaktion is a must. Definetly the best
                        tool on the market at all! in addition to the tool, the
                        team behind Reaktion is always fresh on new ideas and
                        insights, which are also quickly implemented, Can
